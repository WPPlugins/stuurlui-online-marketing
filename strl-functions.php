...
function strl_settings_link( $actions, $plugin_file ) {
  ...
  if ($plugin == $plugin_file) {
      ...
      $site_link = array('support' => '<a href="http://wijzijnstuurlui.nl/contact" target="_blank">Support</a>');
...
function strl_add_header_scripts() {
    ...
    if ($strl_checkbox_field_fontawesome == 1) {
      wp_enqueue_style( 'fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array(), null, true);
    }
}
